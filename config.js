...
global.sgh = 'https://github.com/MOD-YO-COID/' // github
...
/*============== PAYMENT ==============*/
global.pdana = '082179721320' //dana
global.povo = '082179721320' //ovo
global.pgopay = '082179721320' //gopay
global.plinkaja = '082179721320' //link aja
global.ppulsa = '082179721320' //telkomsel
global.ppulsa2 = '-' // kalau ada kartu lain isi aja
global.psaweria = '-'

/*============== NOMOR ==============*/
global.nomorbot = '6283117601774'
global.nomorown = '6282179721320'
global.namebot = 'WH-MODS-BOT-V1'
global.nameown = 'WH MODS DEV'

/*============== Github Thanks To ==============*/
global.namagithub = 'MOD-YO-COID' // nama github lu
global.linkgithub = 'https://github.com/MOD-YO-COID/' // tarok link github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['6282179721320', 'developer', true],
  ['6283117601774', 'bot', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
